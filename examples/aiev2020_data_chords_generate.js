...
// Generating chords excerpts in 4-4 time for AI Eurovision 2020 project.

// Individual user paths.
const mainPaths = {
  "tom": {
    "stm": __dirname + "/stm/aiev2020_data_chords.js",
    "initial": __dirname + "/stm/aiev2020_data_chords_initial.js",
    "outputDir": __dirname + "/out/aiev_data_chords/"
  },
  "anotherUser": {
    "stm": "",
    "initial": "",
...
// Set up parameters.
let seeds = ["Alligator", "Armadillo", "Bee", "Butterfly", "Cat", "Chameleon", "Dove", "Dragonfly", "Elephant", "Firefly", "Gopher", "Hippopotamus", "Hummingbird", "Iguana", "Jay", "Leopard", "Lion", "Lynx", "Magpie", "Mosquito", "Nightingale", "Orangutan", "Orca", "Peacock", "Slug", "Tiger", "Toad", "Tortoise", "Whale", "Zebra"]
let param = {
...
seeds.map(function(seed){
  ...
  fs.writeFileSync(
    pathsEtc.outputDir + "chords_" + seed + ".mid",
  ...
  // )
  fs.writeFileSync(
    pathsEtc.outputDir + "chords_" + seed + ".txt",
