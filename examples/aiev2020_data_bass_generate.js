...
// Generating bass excerpts in 4-4 time for AI Eurovision 2020 project.

// Individual user paths.
const mainPaths = {
  "tom": {
    "stm": __dirname + "/stm/aiev2020_data_bass.js",
    "initial": __dirname + "/stm/aiev2020_data_bass_initial.js",
    "outputDir": __dirname + "/out/aiev_data_bass/"
  },
  "anotherUser": {
    "stm": "",
    "initial": "",
...
seeds.map(function(seed){
  ...
  fs.writeFileSync(
    pathsEtc.outputDir + "bass_" + seed + ".mid",
  ...
  // })
  // fs.writeFileSync(
  //   pathsEtc.outputDir + "bass_" + seed + "_ableton.mid",
  //   new Buffer(midi.toArray())
  // )
  fs.writeFileSync(
    pathsEtc.outputDir + "bass_" + seed + ".txt",
