...
// distribution for chord representations for AI Eurovision 2020 project.
...
const mainPaths = {
  "tom": {
    ...
    "outputFileName": "aiev2020_data_chords"
  },
  "anotherUser": {
    // ...
  }
...
// Parameters
const targetChannel = 1 // Should be where chords are encoded.
const param = {
