...
const mainPaths = {
  "tom": {
    "lyrics": "/Users/tomthecollins/Shizz/York/Projects/AI\ Eurovision/lyrics/",
...
lyrDirs.forEach(function(lyrDir, jDir){
  ...
  fs.writeFileSync(
    mainPath["outputDir"] + "lyrics_" + lyrDir + ".js",
  ...
  fs.writeFileSync(
    mainPath["outputDir"] + "lyrics_" + lyrDir + "_initial.js",
