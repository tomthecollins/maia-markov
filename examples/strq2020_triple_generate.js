...
const mainPaths = {
  "tom": {
    "stm": __dirname + "/stm/strq2020_triple.js",
    "initial": __dirname + "/stm/strq2020_triple_initial.js",
    "final": __dirname + "/stm/strq2020_triple_final.js",
    "outputDir": __dirname + "/out/strq2020_triple/"
  },
  "anotherUser": {
    "stm": "",
    "initial": "",
...
let seeds = [
  [
    "BBQ chicken", "Bianca", "Calzone", "Caprese", "Capricciosa", "Dessert", "Diavola", "Focaccia", "Funghi", "Frutti di mare", "Hawaiian", "La Reine", "Liguria", "Margherita", "Marinara", "Napoletana", "Pepperoni", "Pugliese", "Prosciutto", "Quattro formagi", "Quattro stagioni", "Romana", "Sfincione", "Sicilian", "Sloppy Guiseppe", "Tirolese", "Tuna", "Vegetariana", "Veronese", "Viennese"
  ],
  [
...
let param = {
  ...
  "timeSignatures": [ {"barNo": 1, "topNo": 3, "bottomNo": 4, "ontime": 0} ],
  "stm": null,
  "graph": null,
  "initial": null,
  "final": null,
